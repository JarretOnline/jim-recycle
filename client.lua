...
CreateThread(function()
    ...
    { options = { { event = "jim-recycle:Trade:Menu", icon = "fas fa-box", label = "Trade Materials", }, },
					distance = 0.6 })
	Targets["sellmats1"] =
    exports['qb-target']:AddCircleZone("sellmats1", vector3(Config.Locations['Recycle1'].location.x, Config.Locations['Recycle1'].location.y, Config.Locations['Recycle1'].location.z), 2.0, { name="sellmats1", debugPoly=Config.Debug, useZ=true, },
    { options = { { event = "jim-recycle:Selling:Menu", icon = "fas fa-box", label = "Sell Materials", }, },
					distance = 2.0 })
	Targets["sellmats2"] =
    exports['qb-target']:AddCircleZone("sellmats2", vector3(Config.Locations['Recycle2'].location.x, Config.Locations['Recycle2'].location.y, Config.Locations['Recycle2'].location.z), 2.0, { name="sellmats2", debugPoly=Config.Debug, useZ=true, },
    { options = { { event = "jim-recycle:Selling:Menu", icon = "fas fa-box", label = "Sell Materials", }, },
					distance = 2.0 })
...
RegisterNetEvent('jim-recycle:Selling:Menu', function()
    exports['qb-menu']:openMenu({
		...
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["can"].image.." width=30px>"..QBCore.Shared.Items["can"].label, params = { event = "jim-recycle:SellAnim", args = 'can' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["bottle"].image.." width=30px>"..QBCore.Shared.Items["bottle"].label, params = { event = "jim-recycle:SellAnim", args = 'bottle' } },

		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["stopsign"].image.." width=30px>"..QBCore.Shared.Items["stopsign"].label, params = { event = "jim-recycle:SellAnim", args = 'stopsign' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["walkingmansign"].image.." width=30px>"..QBCore.Shared.Items["walkingmansign"].label, params = { event = "jim-recycle:SellAnim", args = 'walkingmansign' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["dontblockintersectionsign"].image.." width=30px>"..QBCore.Shared.Items["dontblockintersectionsign"].label, params = { event = "jim-recycle:SellAnim", args = 'dontblockintersectionsign' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["uturnsign"].image.." width=30px>"..QBCore.Shared.Items["uturnsign"].label, params = { event = "jim-recycle:SellAnim", args = 'uturnsign' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["noparkingsign"].image.." width=30px>"..QBCore.Shared.Items["noparkingsign"].label, params = { event = "jim-recycle:SellAnim", args = 'noparkingsign' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["leftturnsign"].image.." width=30px>"..QBCore.Shared.Items["leftturnsign"].label, params = { event = "jim-recycle:SellAnim", args = 'leftturnsign' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["rightturnsign"].image.." width=30px>"..QBCore.Shared.Items["rightturnsign"].label, params = { event = "jim-recycle:SellAnim", args = 'rightturnsign' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["notrespassingsign"].image.." width=30px>"..QBCore.Shared.Items["notrespassingsign"].label, params = { event = "jim-recycle:SellAnim", args = 'notrespassingsign' } },
		{ header = "<img src=nui://"..Config.img..QBCore.Shared.Items["yieldsign"].image.." width=30px>"..QBCore.Shared.Items["yieldsign"].label, params = { event = "jim-recycle:SellAnim", args = 'yieldsign' } },
